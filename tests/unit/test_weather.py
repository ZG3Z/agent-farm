...
class TestWeatherCapabilities:
    ...
    def test_get_weather_valid_location(self, client):
        ...
        result = client.send_request(
            to_agent=AGENT_ID,
            endpoint=ENDPOINT,
            payload={"action": "get_weather", "location": "London"},
        )
    ...
    def test_get_weather_with_country(self, client):
        ...
        result = client.send_request(
            to_agent=AGENT_ID,
            endpoint=ENDPOINT,
            payload={"action": "get_weather", "location": "Paris, France"},
        )
        assert result["status"] == "success"
        assert "weather_info" in result
    ...
    def test_get_weather_empty_location(self, client):
        ...
        result = client.send_request(
            to_agent=AGENT_ID,
            endpoint=ENDPOINT,
            payload={"action": "get_weather", "location": ""},
        )
    ...
    def test_unknown_action(self, client):
        ...
        result = client.send_request(
            to_agent=AGENT_ID,
            endpoint=ENDPOINT,
            payload={"action": "unknown_action", "location": "Berlin"},
        )
        assert result["status"] == "error"
...
class TestWeatherMetadata:
    ...
    def test_response_contains_framework_info(self):
        ...
        result = client.send_request(
            to_agent=AGENT_ID,
            endpoint=ENDPOINT,
            payload={"action": "get_weather", "location": "Berlin"},
        )
